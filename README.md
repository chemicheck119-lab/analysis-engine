...
- [공식 별칭·Top-20 재정렬·도메인 학습 결과](docs/RESOLVER_DOMAIN_RESULTS.md): 이름 보강 효과와 모델 학습 효과를 분리했습니다. CAS를 분리한 공식 명칭 264건에서 학습 보정층의 Top-3가 106→145건으로 개선됐지만, 손실 사례·원문 한계가 있어 운영 Sparse는 유지합니다. 공개 PR/CI 확인 전 로컬 실험 상태입니다.
